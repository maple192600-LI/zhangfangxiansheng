...
> 状态：reference。本文为前端规范参考，当前开发入口以 `../README.md`、`../00_governance/03_tech_constraints.md` 和 `../00_governance/04_coding_conventions.md` 为准。

> 配合 [04_coding_conventions.md](../00_governance/04_coding_conventions.md)、[02_frontend_information_architecture.md](../10_product_design/02_frontend_information_architecture.md) 使用。
