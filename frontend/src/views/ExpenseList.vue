...
const { templateColumns, loadTemplate } = useTemplateColumns('expense_list', { loadExcelHtml: false })
...
async function doExport() {
  try {
    ...
    a.href = url; a.download = getReportFilename('expense_list', { startDate: startDate.value, endDate: endDate.value }); a.click()
