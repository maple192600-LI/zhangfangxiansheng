...
EXPORT_CONFIG = {
    "base_data": {
        "name": "基础数据表",
        "headers": ["日期", "法人简称", "账户名称", "摘要", "对方", "收入", "支出", "余额", "状态"],
    },
    "daily_report": {
        "name": "资金日报",
        "headers": ["法人简称", "期初余额", "收入合计", "支出合计", "净变动", "期末余额"],
    },
    "cash_journal": {
        "name": "现金日记账",
    ...
    "account_balance": {
        "name": "账户余额表",
        "headers": ["法人简称", "账户名称", "期初余额", "本期收入", "本期支出", "期末余额"],
    },
    "income_list": {
        "name": "收入明细表",
        "headers": ["日期", "法人简称", "账户名称", "摘要", "对方", "收入金额", "余额"],
    },
    "expense_list": {
        "name": "支出明细表",
        "headers": ["日期", "法人简称", "账户名称", "摘要", "对方", "支出金额", "余额"],
    },
}
